...
def seed_exercises():
    bench_press = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108092701.jpg",
        owner_id = 1,
    ...
    split_squat = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108093308.jpg",
        experience = "Intermediate",
    ...
    kettlebell_swing = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108100025.jpg",
        experience = "Advanced",
    ...
    lateral_raise = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094814.jpg",
        owner_id = 1,
        experience = "Intermediate",
    ...
    rdl = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108100333.jpg",
        experience = "Intermediate",
    ...
    battle_ropes = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094231.jpg",
        experience = "Advanced",
        target_muscles = "Full Body",
        owner_id = 1,
        created_at = date.today()
    ...
    squat = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108093546.jpg",
        experience = "Advanced",
        target_muscles = "Quads, Hamstrings, Glutes",
        owner_id = 2,
        created_at = date.today()
    ...
    band_pull_aparts = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108095743.jpg",
        experience = "Beginner",
    ...
    bent_over_row = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108095549.jpg",
        experience = "Advanced",
    ...
    calf_raise = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108100230.jpg",
        experience = "Intermediate",
    ...
    step_ups = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094449.jpg",
        experience = "Beginner",
        target_muscles = "Legs",
        owner_id = 2,
        created_at = date.today()
    ...
    lat_pulldown = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108100814.jpg",
        experience = "Intermediate",
        target_muscles = "Lats, Rhomboids, Spinal Erectors, Traps",
        owner_id = 2,
        created_at = date.today()
    ...
    rower = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108093957.jpg",
        experience = "Beginner",
    ...
    push_up = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108095846.jpg",
        experience = "Beginner",
    ...
    deadlift = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108095435.jpg",
        experience = "Advanced",
    ...
    jogging = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094616.jpg",
        experience = "Beginner",
        target_muscles = "Full Body",
        owner_id = 3,
        created_at = date.today()
    ...
    bicep_curls = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094934.jpg",
        experience = "Beginner",
    ...
    ghd = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108094557.jpg",
        experience = "Advanced",
    ...
    tricep_pulldown = Exercise(
        ...
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108100452.jpg",
        experience = "Beginner",
    ...
    prisoner_squats = Exercise(
        ...
        type = "Lower Body",
        description = "Start with your feet slightly more than shoulder width apart and toes positioned at a slight outward angle hands behind your head. Take a breath and brace your core. Start squatting down keeping your back straight pushing your knees out and never letting them cave in, bending at the waist pushing your hips backwards and not flexing your back. Squat down until your quads are parallel to the floor. Maintaining that brace start to rise up from the squat driving with your hips and quads until you are standing straight. Repeat for desired reps.",
        image = "https://workout-development-network.s3.us-east-2.amazonaws.com/Workout-seed-data/IMG20231108095101.jpg",
        experience = "Intermediate",
